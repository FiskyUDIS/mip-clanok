...
\section{Skusanie prveho Git commitu} \label{gitcommits}

\section{Skusanie druheho Git commitu} \label{gitcommits2}

\section{Skusanie novej vetvy} \label{gitcommits3}
